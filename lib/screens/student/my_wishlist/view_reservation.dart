...
class ViewReservation extends StatefulWidget {
  ...
  const ViewReservation({
    super.key, required this.books, required this.image, required this.uid,
  });
    ...
    try {
      await Future.wait([
        Provider.of<BooksViewModel>(context, listen: false)
            .getIndividualBooks(widget.books.bookInfo?.bookInfoId??'', context),
              ...
              Expanded(
                child: ModernButton(
                  ...
                  onPressed: () async {
                    setState(() => _isLoading = true);
                    try {
                      final check = await Provider.of<ReservationViewModel>(context, listen: false)
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        BookInfoColumn(
                          title: 'Edition',
                          value: widget.books.bookInfo?.editionStatement ?? '',
                        ),
                        BookInfoColumn(
                          title: 'Publication Year',
                          value: widget.books.bookInfo?.publicationYear.toString() ?? '',
                        ),
                        BookInfoColumn(
                          title: 'Pages',
                          value: widget.books.bookInfo?.numberOfPages.toString() ?? '',
                        ),
                      ],
                    ),
                  ),
                        ...
                        Row(
                          children: [
                            Flexible(
                              child: BookInfoRow(
                                title: 'Sub Title',
                                value: widget.books.bookInfo?.subTitle ?? '',
                              ),
                            ),
                          ],
                        ),
                        ...
                        Row(
                          children: [
                            Flexible(
                              child: BookInfoRow(
                                title: 'Series',
                                value: widget.books.bookInfo?.seriesStatement ?? '',
                              ),
                            ),
                          ],
                        ),
